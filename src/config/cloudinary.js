...
export const uploadToCloudinary = async (file, folder = 'even-travel/destinations') => {
  // ON UTILISE .upload() AU LIEU DE .upload_stream() → C’EST 100x PLUS STABLE EN AFRIQUE
